...
public class TestSwitch {
    ...
    static void main(String[] args) {
        ...
        Boolean b0 = rt(Boolean.FALSE);
        int r0 = switch (b0) {
            case true -> 10;
            case false -> 20;
        };
        System.out.println("bool0=" + r0);

        Boolean b1 = rt(Boolean.TRUE);
        int r1 = switch (b1) {
            case true -> 11;
            case false -> 22;
        };
        System.out.println("bool1=" + r1);

        Long l = rt(3L);
        switch (l) {
            case 1L -> System.out.println("Long-1");
            case 2L -> System.out.println("Long-2");
            case 3L -> System.out.println("Long-3");
            case 4L -> System.out.println("Long-4");
            default -> System.out.println("Long-def");
        }

        Long l2 = rt(6L);
        switch (l2) {
            case 1L -> System.out.println("Long2-1");
            case 2L -> System.out.println("Long2-2");
            case 3L -> System.out.println("Long2-3");
            case 4L -> System.out.println("Long2-4");
            case 5L -> System.out.println("Long2-5");
            case 6L -> System.out.println("Long2-6");
            default -> System.out.println("Long2-def");
        }

        Double d = rt(9.25d);
        switch (d) {
            case 7.0d -> System.out.println("Double-7.0");
            case 8.0d -> System.out.println("Double-8.0");
            case 9.25d -> System.out.println("Double-9.25");
            case 10.0d -> System.out.println("Double-10.0");
            default -> System.out.println("Double-def");
        }

        Double d2 = rt(4.0d);
        switch (d2) {
            case 1.0d -> System.out.println("Double2-1");
            case 2.0d -> System.out.println("Double2-2");
            case 3.0d -> System.out.println("Double2-3");
            case 4.0d -> System.out.println("Double2-4");
            case 5.0d -> System.out.println("Double2-5");
            default -> System.out.println("Double2-def");
        }

        Float f = rt(2.5f);
        switch (f) {
            case 1.0f -> System.out.println("Float-1.0");
            case 2.5f -> System.out.println("Float-2.5");
            case 3.0f -> System.out.println("Float-3.0");
            case 4.25f -> System.out.println("Float-4.25");
            default -> System.out.println("Float-def");
        }

        Float f2 = rt(5.0f);
        switch (f2) {
            case 1.0f -> System.out.println("Float2-1");
            case 2.0f -> System.out.println("Float2-2");
            case 3.0f -> System.out.println("Float2-3");
            case 4.0f -> System.out.println("Float2-4");
            case 5.0f -> System.out.println("Float2-5");
            case 6.0f -> System.out.println("Float2-6");
            default -> System.out.println("Float2-def");
        }
