...
public class J_U_Arrays {
    ...
    @Stub(javaVersion = Opcodes.V9, ref = @Ref("Ljava/util/Arrays;"))
    ...
    public static int compareUnsigned(byte[] a, byte[] b) {
        ...
        int length = Math.min(aLength, bLength);
        for (int i = 0; i < length; i++) {
            int result = J_L_Byte.compareUnsigned(a[i], b[i]);
            if (result != 0) {
                return result;
            }
        }
    ...
    public static int compareUnsigned(
        ...
        int length = Math.min(aLength, bLength);
        for (int i = 0; i < length; i++) {
            int result = J_L_Byte.compareUnsigned(a[aFromIndex + i], b[bFromIndex + i]);
            if (result != 0) {
                return result;
            }
        }
    ...
    public static int compareUnsigned(short[] a, short[] b) {
        ...
        int length = Math.min(aLength, bLength);
        for (int i = 0; i < length; i++) {
            int result = J_L_Short.compareUnsigned(a[i], b[i]);
            if (result != 0) {
                return result;
            }
        }
    ...
    public static int compareUnsigned(
        ...
        int length = Math.min(aLength, bLength);
        for (int i = 0; i < length; i++) {
            int result = J_L_Short.compareUnsigned(a[aFromIndex + i], b[bFromIndex + i]);
            if (result != 0) {
                return result;
            }
        }
    ...
    @Stub(javaVersion = Opcodes.V9, ref = @Ref("Ljava/util/Arrays;"), include = ArraySupport.class)
