...
public class J_U_C_CompletableFuture {
    ...
    @Stub(value = JavaVersion.VERSION_1_9, include = Completer.class)
    ...
    @Stub(value = JavaVersion.VERSION_1_9, desc = "Ljava/util/concurrent/CompletableFuture;", include = DelayedExecutor.class)
    ...
    @Stub(value = JavaVersion.VERSION_1_9, desc = "Ljava/util/concurrent/CompletableFuture;")
