...
public class J_U_S_Collectors {
    ...
    @Stub(value = JavaVersion.VERSION_12, desc = "Ljava/util/stream/Collectors;", include = { Teeing.class, Teeing.PairBox.class })
    ...
    public static class Teeing<T, A1, A2, R1, R2, R> {
        ...
        public Collector<T, PairBox, R> collector() {
            return Collector.of(PairBox::new, PairBox::add, PairBox::combine, PairBox::get, characteristics.toArray(new Collector.Characteristics[0]));
        }
