...
public class J_T_LocalDate {
    ...
    @Stub(value = JavaVersion.VERSION_1_9, desc = "Ljava/time/LocalDate;")
    ...
    public static Stream<LocalDate> datesUntil(LocalDate start, LocalDate endExclusive) {
        var startEpochDay = start.toEpochDay();
        var endEpochDay = endExclusive.toEpochDay();
    ...
    @Stub(value = JavaVersion.VERSION_1_9, include = DatesUntil.class)
