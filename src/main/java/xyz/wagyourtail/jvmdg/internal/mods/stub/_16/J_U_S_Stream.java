...
public class J_U_S_Stream {
    ...
    @Stub(value = JavaVersion.VERSION_16, include = MapMultiConsumer.class)
    ...
    @Stub(value = JavaVersion.VERSION_16, include = MapMultiIntConsumer.class)
    ...
    @Stub(value = JavaVersion.VERSION_16, include = MapMultiLongConsumer.class)
    ...
    @Stub(value = JavaVersion.VERSION_16, include = MapMultiDoubleConsumer.class)
