...
@Stub(javaVersion = Opcodes.V11, ref = @Ref("Ljava/net/http/HttpRequest;"))
...
//        }
    ...
    @Stub(javaVersion = Opcodes.V11, ref = @Ref("Ljava/net/http/HttpRequest$BodyPublisher;"))
    public interface BodyPublisher extends Flow.Publisher<ByteBuffer> {
        long contentLength();
    }

    @Stub(javaVersion = Opcodes.V11, ref = @Ref("Ljava/net/http/HttpRequest$Builder;"))
    ...
    @Stub(javaVersion = Opcodes.V11, ref = @Ref("Ljava/net/http/HttpRequest$BodyPublishers;"))
