...
@Stub(javaVersion = Opcodes.V1_8, ref = @Ref("Ljava/util/PrimitiveIterator"))
public interface J_U_PrimitiveIterator<T, T_CONS> extends Iterator<T> {

    void forEachRemaining(T_CONS action);

    @Stub(javaVersion = Opcodes.V1_8, ref = @Ref("Ljava/util/PrimitiveIterator$OfInt"))
    ...
    @Stub(javaVersion = Opcodes.V1_8, ref = @Ref("Ljava/util/PrimitiveIterator$OfLong"))
    ...
    @Stub(javaVersion = Opcodes.V1_8, ref = @Ref("Ljava/util/PrimitiveIterator$OfDouble"))
