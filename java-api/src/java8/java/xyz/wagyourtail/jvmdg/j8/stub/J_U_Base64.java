...
@Stub(javaVersion = Opcodes.V1_8, ref = @Ref("java/util/Base64"))
public class J_U_Base64 {
    ...
    @Stub(javaVersion = Opcodes.V1_8, ref = @Ref("java/util/Base64$Encoder"))
    ...
    @Stub(javaVersion = Opcodes.V1_8, ref = @Ref("java/util/Base64$Decoder"))
