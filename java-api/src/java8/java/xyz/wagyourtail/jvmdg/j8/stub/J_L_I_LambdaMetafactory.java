...
public class J_L_I_LambdaMetafactory {
    ...
    @Stub(javaVersion = Opcodes.V1_8, ref = @Ref(value = "Ljava/lang/invoke/LambdaMetafactory", member = "altMetafactory", desc = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;"))
