...
public class J_I_InvalidClassException {
    ...
    @Modify(javaVersion = Opcodes.V19, ref = @Ref(value = "Ljava/io/InvalidClassException;", member = "<init>", desc = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V;"))
    ...
    @Modify(javaVersion = Opcodes.V19, ref = @Ref(value = "Ljava/io/InvalidClassException;", member = "<init>", desc = "(Ljava/lang/String;Ljava/lang/Throwable;)V;"))
